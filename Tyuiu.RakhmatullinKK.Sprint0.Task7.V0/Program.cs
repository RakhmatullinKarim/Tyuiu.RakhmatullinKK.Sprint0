...
using Tyuiu.RakhmatullinKK.Sprint0.Task7.V0.Lib

namespace Tyuiu.RakhmatullinKK.Sprint0.Task7.V0
{
    class Program
    {
        static void Main(string[] args)
        {
            Console.Title = "Спринт #0 | Выполнил: Рахматуллин К.К. | АСОиУб-23-2";
            Console.WriteLine("***************************************************************************");
